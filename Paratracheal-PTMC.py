...
# %%
#1.3数值数据校准和归一化
data_encImpute=pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/0.数据/3.V2P编码后_插补.csv')
...
# %%
#3.1
target=data_encImpute['Paratracheal LNM'].astype(int)
...
# %%
#将矫正后的数据保存下来
data_scaled.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/3.V2P编码后_插补矫正后.csv')

# %% [markdown]
# 4、降维（减少因子之间的多重共线性的问题）

# %%
data=pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/1.总P编码后_插补矫正后.csv')
...
#4.1移除方差特征
data_feature = data[['Age','Sex','BMI','Tumor border','Aspect ratio','Composition','Internal echo pattern','Internal echo homogeneous',
                     'Calcification','Tumor internal vascularization','Tumor Peripheral blood flow','Size','Location','Mulifocality','Hashimoto',
                     'Extrathyroidal extension','Side of position','Prelaryngeal LNM','Pretracheal LNM','Con-Paratracheal LNM',
                     'LNM-prRLN',
                     'age','bmi','size',
                     'Prelaryngeal LNMR','Prelaryngeal NLNM','Pretracheal LNMR','Pretracheal NLNM',
                     'Con-Paratracheal LNMR','Con-Paratracheal NLNM','LNMR-prRLN','NLNM-prRLN',
    
    ]]


data_target=data['Paratracheal LNM']
...
# 加载数据
train_data = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/1.总P编码后_插补矫正后.csv')
val_data1 = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/2.V1P编码后_插补矫正后.csv')
val_data2 = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/3.V2P编码后_插补矫正后.csv')
# 提取特征和目标
feature_cols = ['Age','Sex','Aspect ratio','Internal echo homogeneous',
                     'Calcification','Size','Location','Mulifocality','Hashimoto',
                     'Extrathyroidal extension','Side of position','Pretracheal LNM',
                     ]
target_col = 'Paratracheal LNM'
...
# 数值变量标准化
#num_cols = [ 'Prelaryngeal LNMR','Prelaryngeal NLNM','Pretracheal LNMR','Pretracheal NLNM',
           #          'Con-Paratracheal LNMR','Con-Paratracheal NLNM','LNMR-prRLN','NLNM-prRLN',]
#cat_cols = ['Age','Sex','Aspect ratio','Internal echo homogeneous',
     #                'Calcification','Size','Location','Mulifocality','Hashimoto',
           #          'Extrathyroidal extension','Side of position','Pretracheal LNM',
                   #  ]
...
plt.title('ROC For Paratracheal Lymph Node Metastasis-Removing variance characteristics(Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图4/Figure4-A1-ROC All Machine Learning Algorithms-Removing variance characteristics{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.figure(figsize=(8, 6))
plt.plot(fpr, tpr, color='#3D5714', label='Train Set (AUC = %0.3f)' % best_auc)
plt.plot(fpr_test, tpr_test, color='#79902D', label='Test Set (AUC = %0.3f)' % test_auc)
plt.plot(fpr_val1, tpr_val1, color='#5AB682', label='Validation Set1 (AUC = %0.3f)' % val_auc1)
plt.plot(fpr_val2, tpr_val2, color='#CBE4D2', label='Validation Set2 (AUC = %0.3f)' % val_auc2)
plt.plot([0, 1], [0, 1], 'k--')  # 绘制对角线
plt.grid(True)
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Paratracheal Lymph Node Metastasis-Removing variance characteristics')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['JPEG']
dpis = [300]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图4/Figure4-A2-ROC All Machine Learning Algorithms-Removing variance characteristics{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 绘制DCA曲线
plt.figure(figsize=(8, 6))
plt.plot(decision_thresholds, net_benefits_train, color='#3D5714', lw=2, label='Training set')
plt.plot(decision_thresholds, net_benefits_test, color='#79902D', lw=2, label='Test set')
plt.plot(decision_thresholds, net_benefits_val1, color='#5AB682', lw=2, label='Validation set1')
plt.plot(decision_thresholds, net_benefits_val2, color='#CBE4D2', lw=2, label='Validation set2')
...
plt.title('DCA for Paratracheal Lymph Node Metastasis-Removing variance characteristics', fontsize=14)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图4/Figure2-A4-dca All Machine Learning Algorithms-Removing variance characteristics{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/1.A气管旁Removing variance characteristics.csv', index=False)
...
val_data2 = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/3.V2P编码后_插补矫正后.csv')
# 提取特征和目标
feature_cols = ['Sex','Tumor border','Tumor internal vascularization','Tumor Peripheral blood flow',
                     'Extrathyroidal extension','Prelaryngeal LNM','Pretracheal LNM','Con-Paratracheal LNM',
                    
                     'age','size','Prelaryngeal NLNM','Con-Paratracheal LNMR','Con-Paratracheal NLNM','LNMR-prRLN',]
target_col = 'Paratracheal LNM'
...
val_target2 = val_data2[target_col]
# 数值变量标准化
num_cols = ['age','size','Prelaryngeal NLNM','Con-Paratracheal LNMR','Con-Paratracheal NLNM','LNMR-prRLN',]
cat_cols = ['Sex','Tumor border','Tumor internal vascularization','Tumor Peripheral blood flow',
                     'Extrathyroidal extension','Prelaryngeal LNM','Pretracheal LNM','Con-Paratracheal LNM',]
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Paratracheal Lymph Node Metastasis (Train set)')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-D1-Paratracheal-roc-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Paratracheal Lymph Node Metastasis-XGBOOST')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['JPEG']
dpis = [300]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure6-D1-Paratracheal-roc-ALL-SET_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('Threshold Probability', fontsize=12)
plt.ylabel('Net Benefit', fontsize=12)
plt.title('DCA for Paratracheal Lymph Node Metastasis-XGBOOST', fontsize=14)
plt.legend(loc="lower right", fontsize=10)
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.xlim(0, 0.8)
plt.ylim(-0.1, 0.4)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure6-D2-Paratracheal-DCA-ALL-SET_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.D.Paratracheal训练集的评价指标.csv', index=False)
...
plt.title('DCA For Paratracheal Lymph Node Metastasis(Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-D1-Paratracheal-DCA-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Paratracheal Lymph Node Metastasis(Train set)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-D1-Paratracheal-CC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Paratracheal Lymph Node Metastasis(Train set)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-D1-Paratracheal-PRC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
model_param_grid = {
   'Logistic Regression': (LogisticRegression(random_state=33), {'C': [0.01, 0.1, 1, 10, 100]}),
    ...
    'Decision Tree': (DecisionTreeClassifier(random_state=33), {'max_depth': [5, 7, 10, 15], 'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4]}),
    'Random Forest': (RandomForestClassifier(random_state=33), {'n_estimators': [50, 100, 150], 'max_depth': [1, 3, 4], 'min_samples_split': [1, 5,7]}),
    'Extra Trees': (ExtraTreesClassifier(random_state=33), {'n_estimators': [10, 30, 70], 'max_depth': [3, 5, 7], 
                                                            'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4], 'max_features': ['sqrt', 'log2', None]}),
    'AdaBoost': (AdaBoostClassifier(random_state=33), {'n_estimators': [50, 100, 150], 'learning_rate': [0.01, 0.1, 1.0]}),
    'Gradient Boosting': (GradientBoostingClassifier(random_state=33), {'n_estimators': [10, 50, 70], 'learning_rate': [0.01, 0.03, 0.05],}),
    'HistGradientBoosting': (HistGradientBoostingClassifier(random_state=33), {'max_iter': [50, 100, 200], 'max_depth': [1, 3, 5], 'learning_rate': [0.01, 0.1, 0.2]}),
    ...
    'CatBoost': (CatBoostClassifier(random_state=33, silent=True), {'depth': [1, 3, 5], 'learning_rate': [0.05, 0.1, 0.2]}),
    'Support Vector Machine': (SVC(probability=True, random_state=33), {'C': [0.01, 0.1, 1, 10, 100], 'kernel': ['linear', 'rbf'], 'gamma': ['scale', 'auto']}),
    'K-Nearest Neighbors': (MLPClassifier(random_state=33), {'hidden_layer_sizes': [(11,), (22,), (33,)],}),
    'Neural Network': (MLPClassifier(random_state=33), {'hidden_layer_sizes': [(10,), (20,), (30,)],}),
    'Gaussian Naive Bayes': (GaussianNB(), {}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Paratracheal Lymph Node Metastasis(Test set)')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-D2-Paratracheal-roc-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
Val_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.2D.Paratracheal测试集(内验证)的评价指标新.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Paratracheal Lymph Node Metastasis(Test set)')
plt.legend(loc='upper right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-D2-Paratracheal-DCA-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Paratracheal Lymph Node Metastasis(Test set)")
plt.tight_layout()
# 保存图像
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-D2-Paratracheal-CC-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.title("Precision Recall Curves For Paratracheal Lymph Node Metastasis(Test set)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-D2-Paratracheal-PRC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 定义模型和参数空间
model_param_grid = {
  'Logistic Regression':(DecisionTreeClassifier(random_state=33), {'max_depth': [5, 7, 10, 15], }),

    'Decision Tree': (DecisionTreeClassifier(random_state=33), {'max_depth': [5, 7, 10, 15], 'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4]}),
    'Random Forest': (RandomForestClassifier(random_state=33), {'n_estimators': [3, 23, 66], }),
    'Extra Trees': (RandomForestClassifier(random_state=33), {'n_estimators': [10, 30, 50], }),
                                                           
    'AdaBoost': (RandomForestClassifier(random_state=33), {'n_estimators': [4, 88, 150], }),
    'Gradient Boosting':  (RandomForestClassifier(random_state=33), {'n_estimators': [10, 40, 70], }),
    'HistGradientBoosting': (HistGradientBoostingClassifier(random_state=33), {'max_iter': [5, 10, 20], }),
    'XGBoost': (XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [1,300,800],'max_depth': [1,3,15],'learning_rate': [0.01, 0.1, 0.2],
                                                                                             'subsample': [0.5, 1.0],'gamma': [0, 0.1, 0.8],'colsample_bytree': [0.5, 0.7,1.2],
                                                                                             'min_child_weight': [1, 10],'scale_pos_weight': [1, 10],'reg_alpha': [0, 0.5],
                                                                                             'reg_lambda': [0,0.5],}), 
    'CatBoost':  (RandomForestClassifier(random_state=33), {'n_estimators': [5, 20, 45], }),
    'Support Vector Machine': (SVC(probability=True, random_state=33), {'C': [0.01, 0.1, 1, ], }),
    'K-Nearest Neighbors': (KNeighborsClassifier(), {'n_neighbors': [1, 2, 5],'weights': ['uniform'],'algorithm': ['ball_tree', 'kd_tree']}),
    'Neural Network':  (RandomForestClassifier(random_state=33), {'n_estimators': [5, 13, 33], }),
    'Gaussian Naive Bayes': (GaussianNB(), {}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Paratracheal Lymph Node Metastasis(Validation Set1)')
plt.legend(loc='lower right')
# 保存图像
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-D3-Paratracheal-roc-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.3.Paratracheal验证集1的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Paratracheal Lymph Node Metastasis(Validation Set1)')
plt.legend(loc='upper right')
# 保存图像
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-D3-Paratracheal-dca-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Paratracheal Lymph Node Metastasis(Validation set1)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-D3-Paratracheal-CC-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Paratracheal Lymph Node Metastasis(Validation set1)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-D3-Paratracheal-PRC-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Paratracheal Lymph Node Metastasis(Validation Set2)')
plt.legend(loc='lower right')
# 保存图像
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-D4-Paratracheal-roc-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# Export metrics to CSV
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.4.Paratracheal验证集2的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Paratracheal Lymph Node Metastasis(Validation Set2)')
plt.legend(loc='upper right')
# 保存图像
formats = ['JPEG']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-D4-Paratracheal-dca-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Paratracheal Lymph Node Metastasis(Validation set2)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-D4-Paratracheal-CC-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Paratracheal Lymph Node Metastasis(Validation set2)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-D4-Paratracheal-PRC-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
def plot_learning_curve_with_external(estimator, title, X_train, y_train, X_test1, y_test1, X_test2, y_test2, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5)):
    plt.figure()
    plt.title(f"Learning Curve For Paratracheal Lymph Node Metastasis: {title}")
    ...
    for fmt in formats:
        for dpi in dpis:
            plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure5-Paratracheal-LC_{title}_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
    plt.show()
...
nomogram_results = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/1.R语言的结果/5.对比/4.Paratracheal.LNM.nomogram_predictions.csv')
...
plt.title('Win Probability Heatmap For Paratracheal Lymph Node Metastasis')
plt.xlabel('model b')
plt.ylabel('model a')
plt.tight_layout()
prob_heatmap_XGB_path = '/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/4.补充材料3-模型对比/Figure1-D-Paratracheal-win_probability_heatmap.tiff'
...
plt.title('Wald Test p-value Heatmap For Paratracheal Lymph Node Metastasis')
plt.xlabel('model b')
plt.ylabel('model a')
plt.tight_layout()
pvalue_heatmap_XGB_path = '/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/4.补充材料3-模型对比/Figure2-D-Paratracheal-wald_pvalue_heatmap_all.tiff'
...
# 保存到CSV
csv_path = '/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/4.补充材料3-模型对比/Table4-Paratracheal-pmra_ranking.csv'
...
df = pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/1.总P编码后_插补矫正后.csv')
y = df['Paratracheal LNM']
X = df.drop(['Paratracheal LNM'], axis=1)
...
other_params = {'eta': 0.027825594022071243, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
...
other_params = {'eta': 0.027825594022071243, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
                'colsample_bytree': 0.0, 'colsample_bylevel': 0.0, 'subsample': 0.8421052631578947, 'reg_lambda': 0.30000000000000004, 'reg_alpha': 0.20833333333333334,}
...
other_params = {'eta': 0.027825594022071243, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
                'colsample_bytree': 0.0, 'colsample_bylevel': 0.0, 'subsample': 0.8421052631578947, 'reg_lambda': 0.6000000000000001, 'reg_alpha': 0.20833333333333334,}
...
other_params = {'eta': 0.027825594022071243, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
                'colsample_bytree': 0.0, 'colsample_bylevel': 0.0, 'subsample': 0.8421052631578947, 'reg_lambda': 0.6000000000000001, 'reg_alpha': 0.625,}
...
other_params = {'eta': 0.046415888336127774, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
                'colsample_bytree': 0.0, 'colsample_bylevel': 0.0, 'subsample': 0.8421052631578947, 'reg_lambda': 0.6000000000000001, 'reg_alpha': 0.625,}
...
X = df[['Sex','Tumor border','Tumor internal vascularization','Tumor Peripheral blood flow',
                     'Extrathyroidal extension','Prelaryngeal LNM','Pretracheal LNM','Con-Paratracheal LNM',
...
params = {'eta': 0.046415888336127774, 'n_estimators': 188, 'gamma': 0.001, 'max_depth': 5, 'min_child_weight': 4,
                'colsample_bytree': 0.0, 'colsample_bylevel': 0.0, 'subsample': 0.8421052631578947, 'reg_lambda': 0.6000000000000001, 'reg_alpha': 0.625,'seed': 33}
...
# 绘制堆叠条形图
ax.barh(index, mean_shap_values_non_metastasis, bar_width, color='blue', label='Non-Metastasis (Paratracheal Lymph Node Metastasis=No)')
...
ax.set_title('Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Bar Plot')
ax.set_yticks(index)
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D1-Paratracheal-combined_shap_bar_plot_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
# 显示图像
plt.show()
...
# 获取当前的绘图对象
plt.gca().set_title("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Summary Plot")
# 调整布局以确保图像显示正常
plt.tight_layout()
# 保存为 TIFF 格式，路径为指定位置，命名为 figure-5-a2
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D2-Paratracheal-summary_plot_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
# 显示图像
plt.show()
...
plt.suptitle("Feature Interaction Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Interaction Values Plot ", 
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D3-Paratracheal-interaction_plot_300dpi.jpg', format='JPEG', dpi=300, bbox_inches='tight')
# 显示图像
plt.show()
...
# 使用 suptitle 设置左对齐的标题，x=0 表示从最左侧开始
plt.suptitle("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Bar Plot", 
             x=0.01, y=0.98, ha='left', fontsize=12)
# 调整布局和边距，确保所有内容能显示完全
plt.tight_layout(rect=[0, 0, 1, 0.95])  # 调整整体布局
plt.subplots_adjust(top=0.88)  # 调整顶部边距，确保标题不与图形内容重叠
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D1.2-Paratracheal-bar_plot_300dpi.JPEG', format='JPEG', dpi=300, bbox_inches='tight')
...
# 使用 suptitle 设置左对齐的标题，x=0 表示从最左侧开始
plt.suptitle("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Decision Plot(All Samples)", 
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D4-Paratracheal-decision_plot_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
...
# 设置标题并左对齐
plt.suptitle("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Decision Plot(Random 20 Samples)", 
             x=0.01, y=0.98, ha='left', fontsize=10)

# 保存为 TIFF 格式，命名为 Figure5-a5
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D5-Paratracheal-decision_plot_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
...
# 设置标题并左对齐
plt.suptitle("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Decision Plot(Highlighted Misclassified Samples)", 
             x=0.01, y=0.98, ha='left', fontsize=10)

# 保存为 TIFF 格式，命名为 Figure5-a6
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D6-Paratracheal-misclassified_decision_plot_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
...
# 设置保存路径
save_path = '/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D7-Paratracheal-force_plot.html'
...
# 保存 HTML 文件路径
save_html_single_path = '/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D8-Paratracheal-force_plot_single_case.html'
...
# 保存为 TIFF 格式
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D8-Paratracheal-force_plot_single_case_300dpi.JPEG', format='JPEG', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D5.2-Paratracheal-decision_plot_random_20_samples_300dpi.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()

# 预测并找出错误分类的样本
y_pred = (shap_values.sum(1) + expected_value) > 0
misclassified = y_pred != y[1846:1866]
...
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D6.2-Paratracheal-decision_plot_misclassified_samples_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
if len(misclassified_indices) > 0:
    ...
    plt.suptitle("Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Decision Plot(Misclassified Sample)", 
                 x=0.01, y=0.98, ha='left', fontsize=10)
    plt.tight_layout(rect=[0, 0, 1, 0.95])
    plt.subplots_adjust(top=0.88)
    plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-D7-Paratracheal-decision_plot_misclassified_sample_300dpi.JPG', format='JPEG', dpi=300, bbox_inches='tight')
    plt.show()
else:
...
titles = [
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-Heatmap Plot",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Bar Plot",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Bar Plot(Absolute Maximum Values)",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Beeswarm Plot",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Beeswarm Plot",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Bar Plot(Clustering)",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Bar Plot(Clustering-cutoff=0.8)",
    "Feature Importance by SHAP Values for Paratracheal Lymph Node Metastasis and Non-Metastasis-SHAP Bar Plot(Clustering-cutoff=1.8)"
]
filenames = [
    "Figure5-D9-Paratracheal-heatmap_300dpi.JPEG",
    "Figure5-D10-Paratracheal-bar_plot_300dpi.JPEG",
    "Figure5-D11-Paratracheal-bar_plot_abs_max_300dpi.JPEG",
    "Figure5-D12-Paratracheal-beeswarm_300dpi.JPEG",
    "Figure5-D13-Paratracheal-beeswarm_red_300dpi.JPEG",
    "Figure5-D14-Paratracheal-bar_plot_clustering_300dpi.JPEG",
    "Figure5-D15-Paratracheal-bar_plot_clustering_cutoff_0.8_300dpi.JPEG",
    "Figure5-D16-Paratracheal-bar_plot_clustering_cutoff_1.8_300dpi.JPEG"
]
...
cmap = mcolors.LinearSegmentedColormap.from_list("#3D5714", ["#79902D", "#CBE4D2"])
...
plt.ylabel('Feature')
plt.title('Bar Plot of Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure6-D1-Paratracheal-bar-plot.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
# 3. 创建颜色渐变（从深红到浅红）
cmap_top_10 = mcolors.LinearSegmentedColormap.from_list("#3D5714", ["#79902D", "#CBE4D2"])
...
plt.xlabel('Contribution (%)')
plt.ylabel('Feature')
plt.title('Top 10 Feature Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')
plt.gca().invert_yaxis()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D1.1-Paratracheal-top10-bar-plot.eps', format='eps', dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel('Contribution (%)')
plt.ylabel('Feature')
plt.title('Bubble Chart of Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')
...
# 保存全样本泡泡图
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D2-Paratracheal-bubble-plot.eps', format='eps', dpi=300, bbox_inches='tight')
plt.show()
...
# 保存Top 10泡泡图
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D2.2-Paratracheal-top10-bubble-plot.JPG', 
...
plt.title('Pie Chart of Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')

# Save the pie chart as a TIFF image with 300 dpi
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D3-Paratracheal-pie-chart.jpg', format='JPEG', dpi=600, bbox_inches='tight')
plt.show()
...
plt.title('Top 10 Pie Chart of Importances and Contributions Percentage based on SHAP values for Paratracheal Central Lymph Node Metastasis XGBoost Model')

# Save the top 10 pie chart as a TIFF image with 300 dpi
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D3.2-Paratracheal-top10-pie-chart.jpg', format='JPEG', dpi=600, bbox_inches='tight')
plt.show()
...
plt.title('Donut Chart of Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')

# Save the donut chart as a TIFF image with 300 dpi
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D4-Paratracheal-donut-chart.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Top 10 Donut Chart of Importances and Contributions Percentage based on SHAP values for Paratracheal Lymph Node Metastasis XGBoost Model')

# Save the top 10 donut chart as a TIFF image with 300 dpi
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D4.2-Paratracheal-top10-donut-chart.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Paratracheal Lymph Node Metastasis Heatmap of All Features (Sorted by SHAP Importance)')
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D5-Paratracheal-SHAP-heatmap-all.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Paratracheal Lymph Node Metastasis Heatmap of Top 10 Features (Sorted by SHAP Importance)')
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-D5-Paratracheal-SHAP-heatmap-top10.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
