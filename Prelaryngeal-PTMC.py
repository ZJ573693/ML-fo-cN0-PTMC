...
# %%
#1.3数值数据校准和归一化
data_encImpute=pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/0.数据/2.V1H编码后_插补.csv')
...
# %%
#3.1
target=data_encImpute['Prelaryngeal LNM'].astype(int)
...
# %%
#将矫正后的数据保存下来
data_scaled.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/2.V1H编码后_插补矫正后.csv')

# %% [markdown]
# 4、降维（减少因子之间的多重共线性的问题）

# %%
data=pd.read_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/0.数据/1.总H编码后_插补矫正后.csv')
...
data_feature = data[['Age','Sex','BMI','Tumor border','Aspect ratio','Composition','Internal echo pattern','Internal echo homogeneous','Calcification','Tumor internal vascularization',
                     'Tumor Peripheral blood flow','Size','Location','Mulifocality','Hashimoto','Extrathyroidal extension','Side of position','Pretracheal LNM','Paratracheal LNM',
                     'Con-Paratracheal LNM','LNM-prRLN',
                     
                     'age','bmi','size','Pretracheal LNMR','Pretracheal NLNM','Paratracheal LNMR','Paratracheal NLNM','Con-Paratracheal LNMR','Con-Paratracheal NLNM',
                     'LNMR-prRLN','NLNM-prRLN'
...
# %%
set_kit=SelectKBest(chi2,k=14)#选取k值最高的10(5)个元素
...
plt.title('ROC For Prelaryngeal Lymph Node Metastasis-L1-based Feature Selection (Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图2/Figure2-E1-ROC All Machine Learning Algorithms-L1-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.figure(figsize=(8, 6))
plt.plot(fpr, tpr, color='#BB431C', label='Train Set (AUC = %0.3f)' % best_auc)
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Prelaryngeal Lymph Node Metastasis-L1-based Feature Selection')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['tiff']
dpis = [300]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图2/Figure2-E2-ROC All Machine Learning Algorithms-L1-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.title('DCA for Prelaryngeal Lymph Node Metastasis-L1-based Feature Selection', fontsize=14)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/图2/Figure2-E3-dca All Machine Learning Algorithms-L1-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/1.补充材料1-筛选变量/1.E喉前L1-based Feature Selection.csv', index=False)
...
model_param_grid = {
    ...
    'CatBoost': (CatBoostClassifier(random_state=33, silent=True), {'depth': [1, 3, 5], 'learning_rate': [0.01, 0.1, 0.2]}),
    'Support Vector Machine': (SVC(probability=True, random_state=33), {'C': [0.01, 0.1, 1, 10, 100], 'kernel': ['linear', 'rbf'], 'gamma': ['scale', 'auto']}),
    'K-Nearest Neighbors': (KNeighborsClassifier(), {'n_neighbors': [50, 100, 200],'weights': ['uniform'],'algorithm': ['ball_tree', 'kd_tree']}),
    'Neural Network': (MLPClassifier(random_state=33), {'hidden_layer_sizes': [(10,), (20,), (50,)], 'activation': ['relu', 'tanh'], 'solver': ['adam', 'sgd']}),
    'Gaussian Naive Bayes': (GaussianNB(), {}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Prelaryngeal Lymph Node Metastasis (Train set)')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-B1-Prelaryngeal-roc-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure6-B1-Prelaryngeal-roc-ALL-SET_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure6-B2-Prelaryngeal-DCA-ALL-SET_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.1.Prelaryngeal训练集的评价指标.csv', index=False)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-B1-Prelaryngeal-DCA-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-B1-Prelaryngeal-CC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-B1-Prelaryngeal-PRC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 定义模型和参数空间
model_param_grid = {
   'Logistic Regression': (DecisionTreeClassifier(random_state=33), {'max_depth': [1, 2, 3]}),
    ...
    'Gaussian Naive Bayes': (CatBoostClassifier(silent=False), {}),
}
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-B2-Prelaryngeal-roc-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
Val_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.2.Prelaryngeal测试集(内验证)的评价指标新.csv', index=False)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-B2-Prelaryngeal-DCA-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-B2-Prelaryngeal-CC-Test_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-B2-Prelaryngeal-PRC-Train_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 定义模型和参数空间
model_param_grid = {
    'Logistic Regression':(XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [1,2,5],'reg_lambda': [0,0.5],}), 
    'Decision Tree':(XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [3,6,20],'reg_lambda': [0,0.5],}), 
    'Random Forest': (ExtraTreesClassifier(random_state=33), {'n_estimators': [3, 7, 11]}),
    'Extra Trees': (XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'reg_lambda': [0,0.5],}), 
    'AdaBoost': (ExtraTreesClassifier(random_state=33), {'n_estimators': [4, 6, 8]}),
    'Gradient Boosting': (ExtraTreesClassifier(random_state=33), {'n_estimators': [1,2, 10]}),
    'HistGradientBoosting': (ExtraTreesClassifier(random_state=33), {'n_estimators': [1, 7, 11]}),
    'XGBoost': (XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [10,300,600],'max_depth': [1,5,15],'learning_rate': [0.05, 0.1, 0.2],
                                                                                             'subsample': [0.5, 1.0],'gamma': [0, 0.1, 0.8],'colsample_bytree': [0.5, 0.7,1.0],
                                                                                             'min_child_weight': [1, 10],'scale_pos_weight': [1, 10],'reg_alpha': [0, 0.5],
                                                                                             'reg_lambda': [0,0.5],}), 
    'CatBoost': (ExtraTreesClassifier(random_state=33), {'n_estimators': [7, 8, 9]}),
    'Support Vector Machine': (ExtraTreesClassifier(random_state=33), {'n_estimators': [3, 5, 6]}),
    'K-Nearest Neighbors': (ExtraTreesClassifier(random_state=33), {'n_estimators': [2,3, 4]}),
    'Neural Network':(XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [100,300,500],}), 
    'Gaussian Naive Bayes':(ExtraTreesClassifier(random_state=33), {'n_estimators': [2, 3,7]}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Prelaryngeal Lymph Node Metastasis(Validation Set1)')
plt.legend(loc='lower right')
# 保存图像
formats = ['JPEG']
dpis = [300]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-B3-Prelaryngeal-roc-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.3.Prelaryngeal验证集1的评价指标.csv', index=False)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-B3-Prelaryngeal-dca-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-B3-Prelaryngeal-CC-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-B3-Prelaryngeal-PRC-val1_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 定义模型和参数空间
model_param_grid = {
    'Logistic Regression': (DecisionTreeClassifier(random_state=33), {'max_depth': [6,9,16]}),
    'Decision Tree': (DecisionTreeClassifier(random_state=33), {'max_depth': [10,12,15]}),
    'Random Forest': (DecisionTreeClassifier(random_state=33), {'max_depth': [7,9,11]}),
    'Extra Trees':  (DecisionTreeClassifier(random_state=33), {'max_depth': [8,22,25]}),
    'AdaBoost': (DecisionTreeClassifier(random_state=33), {'max_depth': [7,13,15]}),
    'Gradient Boosting':(DecisionTreeClassifier(random_state=33), {'max_depth': [9,10,11]}),
    'HistGradientBoosting': (DecisionTreeClassifier(random_state=33), {'max_depth': [12,13,14]}),
    'XGBoost': (XGBClassifier(use_label_encoder=False, eval_metric='auc', random_state=33), {'n_estimators': [10,300,600],'max_depth': [1,5,15],'learning_rate': [0.05, 0.1, 0.2],
                                                                                             'subsample': [0.5, 1.0],'gamma': [0, 0.1, 0.8],'colsample_bytree': [0.5,0.7,1.0],
                                                                                             'min_child_weight': [1, 10],'scale_pos_weight': [1, 10],'reg_alpha': [0, 0.5],
                                                                                             'reg_lambda': [0,0.5],}), 
    'CatBoost': (DecisionTreeClassifier(random_state=33), {'max_depth': [7,8,9]}),
    'Support Vector Machine':(DecisionTreeClassifier(random_state=33), {'max_depth': [9,10,13]}),
    'K-Nearest Neighbors': (DecisionTreeClassifier(random_state=33), {'max_depth': [10,13,23]}),
    'Neural Network':(DecisionTreeClassifier(random_state=33), {'max_depth': [11,12,15]}),
    'Gaussian Naive Bayes':(DecisionTreeClassifier(random_state=33), {'max_depth': [9,13,16]}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Prelaryngeal Lymph Node Metastasis(Validation Set2)')
plt.legend(loc='lower right')
# 保存图像
formats = ['JPEG']
dpis = [300]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure1-B4-Prelaryngeal-roc-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# Export metrics to CSV
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/1.4.Prelaryngeal验证集2的评价指标.csv', index=False)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure2-B4-Prelaryngeal-dca-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure3-B4-Prelaryngeal-CC-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure4-B4-Prelaryngeal-PRC-val2_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
def plot_learning_curve_with_external(estimator, title, X_train, y_train, X_test1, y_test1, X_test2, y_test2, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5)):
    plt.figure()
    plt.title(f"Learning Curve For Prelaryngeal Lymph Node Metastasis: {title}")
    ...
    for fmt in formats:
        for dpi in dpis:
            plt.savefig(f'/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/2.补充材料2-筛选模型/Figure5-Prelaryngeal-LC_{title}_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
    plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b1-Prelaryngeal-combined_shap_bar_plot_300dpi.png', format='png', dpi=300, bbox_inches='tight')
# 显示图像
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b3-Prelaryngeal-interaction_plot_300dpi.png', format='png', dpi=300, bbox_inches='tight')
# 显示图像
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b1.2-Prelaryngeal-bar_plot_300dpi.png', format='png', dpi=300, bbox_inches='tight')
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b5-Prelaryngeal-decision_plot_300dpi.png', format='png', dpi=300, bbox_inches='tight')
...
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b6-Prelaryngeal-misclassified_decision_plot_300dpi.png', format='png', dpi=300, bbox_inches='tight')
...
# 保存为 TIFF 格式
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b8-Prelaryngeal-force_plot_single_case_300dpi.png', format='png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b5.2-Prelaryngeal-decision_plot_random_20_samples_300dpi.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout(rect=[0, 0, 1, 0.95])
plt.subplots_adjust(top=0.88)
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b6.2-Prelaryngeal-decision_plot_misclassified_samples_300dpi.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.show()
...
if len(misclassified_indices) > 0:
    ...
    plt.tight_layout(rect=[0, 0, 1, 0.95])
    plt.subplots_adjust(top=0.88)
    plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure5-b7-Prelaryngeal-decision_plot_misclassified_sample_300dpi.tiff', format='tiff', dpi=300, bbox_inches='tight')
    plt.show()
else:
...
plt.savefig(output_dir + filenames[0], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(output_dir + filenames[2], format='png', dpi=300, bbox_inches='tight')
plt.show()

# Figure 4 - Beeswarm plot
shap.plots.beeswarm(shap_values, show=False)
plt.title(titles[3], fontsize=12)
plt.savefig(output_dir + filenames[3], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(output_dir + filenames[4], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(output_dir + filenames[5], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(output_dir + filenames[6], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig(output_dir + filenames[7], format='png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/Figure6-b1-Prelaryngeal-bar-plot.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b1.1-Prelaryngeal-top10-bar-plot.png', format='png', dpi=300, bbox_inches='tight')
plt.show()
...
# 泡泡大小根据SHAP值调整
bubble_sizes = shap_importance_df['Mean Abs SHAP'] * 12000  
...
# 保存全样本泡泡图
#plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b2-Prelaryngeal-bubble-plot.png', format='png', dpi=300, bbox_inches='tight')
#plt.show()
...
# 泡泡大小根据SHAP值调整
bubble_sizes_top10 = top_10_df['Mean Abs SHAP'] * 10000  
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b3-Prelaryngeal-pie-chart.jpg', format='JPEG', dpi=600, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b3.2-Prelaryngeal-top10-pie-chart.jpg', format='JPEG', dpi=600, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b4-Prelaryngeal-donut-chart.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b4.2-Prelaryngeal-top10-donut-chart.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b5-Prelaryngeal-SHAP-heatmap-all.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/Users/zj/Desktop/4.机器学习新/5.ptmc/2.结果/2.py的结果/3.SHAP可视化/figure6-b5-Prelaryngeal-SHAP-heatmap-top10.jpg', format='JPEG', dpi=300, bbox_inches='tight')
plt.show()
